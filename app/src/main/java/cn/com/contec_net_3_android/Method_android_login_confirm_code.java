...
public class Method_android_login_confirm_code {
    public static String loginMachine(String pSessionID, String pUserID, String pPSW, String pSenderid, String pUrl) throws Exception {
        String _MessageHeader = "101096" + pSessionID + "11";
        String _MD5psw_user = MD5_encoding.MD5(String.valueOf(pUserID) + pPSW);
        String _base64Message = Base64.encodeToString(("<?xml version=\"1.0\" encoding=\"UTF-8\" ?><request><qrcode>" + pSenderid + "</qrcode>" + "</request>").getBytes(), 0);
